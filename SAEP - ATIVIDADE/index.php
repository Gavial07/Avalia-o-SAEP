<?php
include 'db.php'; // o banco de dados
?>
...
<body>
    <div class="container">
        ...
        <!-- Tabela de Alunos -- 5) Listagem de Alunos com Estilo CSS (2 Pontos) -- 01/10 -- 10:12 -->
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        echo "<tr>
                                ...
                                <td>{$row['email']}</td>
                                <td>{$row['curso']}</td>
                                <td><a href='editar.php?id={$row['id']}' class='btn-edit'>Editar</a> 
                                <a href='deletar.php?id={$row['id']}' class='btn-delete'>Excluir</a></td>
                              </tr>";
                    }
                } else {
